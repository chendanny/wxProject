		...
		<form action="${root1 }/index/addCource.do" method="post" id="form_box" name="form_box" onSubmit="return false;">
			...
			<ul class="user_information">
				...
				<li>
					...
					<input maxlength="20" placeholder="请输入课程名称(例如：春季软笔初级班)，限20个字内" type="text" required="required" name="courceName" id="courceName"  value="春季软笔" title="请输入课程名称(例如：春季软笔初级班)，限20个字内" /><input type="hidden" id="oldstff" name="oldstff" value="春季软笔"/>
					<a class="clear_btn"></a>
				</li>
				<li>
			...
			<ul class="user_information">
				...
				<li>
					...
					<select required="required" name="paddress" id="paddress">
						<option value="广氮颐康苑">广氮颐康苑</option>
